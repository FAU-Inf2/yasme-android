...
public class ChatTask {
	...
	public boolean addParticipantToChat(long userId, long chatId)
			throws RestServiceException {

		String requestURL = url
				.concat("/addParToChat/" + userId + "/" + chatId);
	...
	public boolean removePartipantFromChat(long userId, long chatId)
			throws RestServiceException {

		String requestURL = url.concat("/removeParFromChat/" + userId + "/"
				+ chatId);
